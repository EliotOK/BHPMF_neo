...
//  Updated for modern R/C++ compatibility.
//
...
void NodeLatent::GibbsUpdate(NodeLatent*** v_tree, double sig_inv,
    ...
    // Vibe Coding 修复 1：dgemm 调用，在末尾补上两个长度参数 1, 1 (因为前面传了 ntrans 和 ytrans 两个字符)
